...
if __name__ == '__main__':
    ...
    for i in range(1,seed):
        prior_paths = ["src/checkpoint/Acrobot/BOOSTED_RESNET/agent_Boosted_RESNET_dqn_task_m={}_kg_{}".format(task, i) for task in
                       tasks]
        for task_id, task in enumerate(tasks):
            ...
            model_name = "agent_Boosted_RESNET_dqn_task_m={}_kg".format(task)
            experiment(alg=ResNetBoostedResidualDQN,
                       ...
                       model_dir="../src/checkpoint/Acrobot/BOOSTED_RESNET",
                       n_steps=5000,
                       n_episodes=10,
                       task=task,
